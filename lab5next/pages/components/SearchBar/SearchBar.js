...
const SearchBar = ({ setSearch, setResultNull }) => {
  ...
  return (
    <Wrapper>
      <Content>
        <UserInput variant="outlined" color="success"  style={{borderColor: 'silver', color: 'white', backgroundColor: 'white'}} label="Хайх" placeholder="gin ..." value={input} onChange={handleOnChange} onKeyPress={handleKeyPress} />
